  ...
  return (
    <section className="flex min-h-svh items-center bg-ink text-paper">
      <div className="wrap py-40">
        {/* 흐려진 달 — 잠깐 가려졌다는 뜻 */}
        <svg viewBox="0 0 48 48" className="h-16 w-16 opacity-60" aria-hidden="true">
        ...
        <p className="t-label mt-10 text-paper/45">ERROR</p>
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <button type="button" onClick={reset} className={`${btnPaper} cursor-pointer`}>
            다시 시도
          </button>
          <Link href="/" className={btnGhostDark}>
            홈으로
          </Link>
        </div>
      </div>
