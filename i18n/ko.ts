...
export const ko = {
  ...
  coena: {
    ...
    body: "생성 결과를 스스로 검사하고, 실패하면 원인을 태그해 다시 만들고, 통과한 것만 내보냅니다. 생물의 자가 치유와 항상성 원리를 LLM 추론 계층에 옮기는 프로젝트입니다.",
    features: [
      { tag: "self.heal()", desc: "오류를 감지하면 원인을 분류해 스스로 재시도합니다" },
      { tag: "self.verify()", desc: "입력한 사실이 결과에 전부 들어갔는지 기계적으로 대조합니다" },
      { tag: "failure.memory", desc: "실패 기록이 쌓일수록 엔진이 정확해집니다" },
    ],
    status: "v0.1 — 교사용 안내문 도우미로 첫 검증 중",
    ctaPrototype: "시제품 열기",
    ctaNotes: "기술 노트",
    srHero: "생성-검사-재시도 루프를 표현한 애니메이션",
  },
