...
export const en: Dict = {
  ...
  coena: {
    ...
    gooey: ["Verify.", "Recover.", "Remember.", "Ship."],
    gooeySr: "Coena verifies, recovers, remembers — and ships only what passed.",
    features: [
    ...
    pricing: {
      ...
      lead: "It's still being built — so this only lists what we can promise today. Pricing goes public at launch.",
      tiers: [
        {
          id: "preview",
          tag: "v0.1 — PREVIEW",
          name: "Preview",
          desc: "The public prototype. Be the first to try Coena's verification loop.",
          price: "Free",
          billing: "at public preview",
          features: [
            "Try the self.verify() loop",
            "Access to the public prototype",
            "Launch news, first",
          ],
        ...
        },
        {
          ...
          tag: "v1.0 — STANDARD",
          name: "Standard",
          desc: "The full release, for individuals and teams.",
          price: "TBA",
          billing: "announced at launch",
          features: [
            "self.heal() self-recovery",
            "self.verify() self-checking",
            "failure.memory across runs",
          ],
          cta: "Get launch updates",
          badge: "",
          highlighted: false,
        },
        {
          ...
          tag: "NOW — STUDIO",
          name: "Studio",
          desc: "We design a Coena pipeline into the project Lunervia builds for you.",
          price: "Custom",
          billing: "per project",
          features: [
            "Verification designed for your project",
  ...
  contact: {
    ...
    channels: [
      ...
      { name: "Instagram", handle: "@4ever2short", meta: "Founder, direct", href: "https://www.instagram.com/4ever2short/" },
